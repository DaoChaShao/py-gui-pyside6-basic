...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/6 23:39
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   26_progressBar.py
# @Desc     :   
...
class WorkThread(QThread):
    process = Signal(str, float, int, int)
    ...
    def run(self):
        ...
        for i in range(1, 101):
            ...
            self.process.emit(self._player, self._time, self._total, i)
